...
GetCoordinateTask::GetCoordinateTask(gzFile file, int file_column, std::vector<int> &image_range,
                                     std::vector<CoordinateInfo> &coordinate_info) :
    m_file(file), file_column_(file_column), m_range(image_range), coordinate_info_(coordinate_info) {
...
int GetCoordinateTask::MergeCoordinateinfo() {
    ...
    coordinate_info_.insert(coordinate_info_.end(), coordinate_.begin(), coordinate_.end());
