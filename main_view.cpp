...
int view(int argc, char *argv[]) {
    cxxopts::Options options("geftools view", "About:  Show the contents of cell bin GEF\n");
    // TODO support restrict gene_list and region for bGEF
    options.set_width(120).add_options()("i,input-file", "Input bGEF/cGEF file [request]",
