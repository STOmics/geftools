...
ThreadPool::ThreadPool(int num) { addThread(num); }
...
// 空闲线程数量
int ThreadPool::idlCount() { return m_idlCnt; }
// 线程数量
int ThreadPool::threadCount() { return m_vecThread.size(); }
